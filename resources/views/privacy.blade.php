...
<html>
    <head>
        <meta charset="utf-8">
        <title>Soundeal: Privacy Policy</title>
	...
	<body>
		...
		<p>Noi di <strong><span id="sito">Soundeal</span></strong> riteniamo che la privacy dei nostri visitatori sia estremamente importante. Questo documento descrive dettagliatamente i tipi di informazioni personali raccolti e registrati dal nostro sito e come essi vengano utilizzati.</p>
		...
		<ul>
			<li><b><span id="azienda">Soundeal</span></b></li>
			<li><span id="cap">95034</span> - <span id="citta">Bronte</span> (<span id="provincia">CT</span>)</li>
			<li>E-mail: <span id="email">uni399647@studium.unict.it</span></li>
		</ul>
